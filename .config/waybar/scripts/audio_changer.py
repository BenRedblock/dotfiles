...
wofi_command = f"echo '{output}' | wofi --show=dmenu --hide-scroll --allow-markup --define=hide_search=true --location=top_right --width=600 --height=400 --xoffset=-60  -c ~/.config/wofi/wallpaper -s ~/.config/wofi/style-wallpaper.css"
